...
model actually receives. 12 of 12 checks pass.
...
written criteria. 21 of 21 criteria pass as of the latest committed run
(evals/RESULTS.md is generated by the runner).
