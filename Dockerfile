...
# node:24 to match the development runtime. This matters concretely: the
# lockfile is generated by npm 11, and node:22-slim ships npm 10, which
# rejects it with "Missing: ... from lock file" and fails the build.
FROM node:24-slim
